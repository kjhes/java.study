...
public class StringFun {
     public static void main(String[] args) {
        ...
        System.out.println("\n=== 3. toCharArray() ===");
        char[] arr = str.toCharArray(); //문자 배열로 접근
//        for (int i = 0; i < arr.length;i++) {
//        	System.out.println(i + "번째 문지:" + arr[i]);
//        }
        for (char ch : arr) { //향상된 for문
            System.out.println(ch); //arr 배열에서 하니씩 꺼내서 ch에 문자변수에 담는다.
        }
       ...
       if (str.length() >= 3) {
            ...
            //substring(시작,끝-1) , substring(0,2):0부터 1까지)
